dungeon_loot.registered_loot = {
	...
	{name = "default:gold_ingot", chance = 0.2},
	{name = "default:copper_ingot", chance = 0.4, count = {1, 6}},
	{name = "default:tin_ingot", chance = 0.4, count = {1, 6}},
	{name = "default:bronze_ingot", chance = 0.3, count = {1, 6}},
	{name = "default:steel_ingot", chance = 0.2, count = {1, 6}},
